...
ConstantValue* compileConstant2(void) {
  ...
  case TK_IDENT:
    eat(TK_IDENT);
    // TODO: check if the integer constant identifier is declared and get its valueobj = checkDeclaredConstant(currentToken->string);
     obj = checkDeclaredConstant(currentToken->string);
...
void compileForSt(void) {
  ...
  checkDeclaredConstant(currentToken->string);
